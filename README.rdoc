...
You can access the yard documentation either through the yard gem or using the 6fusion hosted documentation at {devdocs.6fusion.com}[http://devdocs.6fusion.com]
